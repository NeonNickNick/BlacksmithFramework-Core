...
namespace BlacksmithCore.Infrastructure.Models.Components
{
    ...
    public class PackageContainer
    {
        ...
        public SkillPackageDefinition SkillPackage { get; }
        public ClapSharedFlag Flag { get; set; } = new();
        public PackageContainer(SkillPackageDefinition skillpackage)
        {
        ...
        {
            return new((SkillPackageDefinition)SkillPackage.Copy())
            {
                Flag = Flag.Copy()
            };
        }
        ...
        IComponent<Body>
    {
        ...
        public virtual SkillDeclareResult TryDeclare(ISkillCheckContext sc)
        {
            var skillName = sc.SkillDeclareData.SkillName;
