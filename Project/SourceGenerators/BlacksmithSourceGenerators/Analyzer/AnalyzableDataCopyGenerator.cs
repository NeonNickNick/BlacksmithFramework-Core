...
namespace BlacksmithSourceGenerators.Analyzer
{
    [Generator]
    public class AnalyzableDataCopyGenerator : IIncrementalGenerator
    {
        ...
        private static void AnalyzeMembers(
            ...
            string className)
        {
            var clockType = compilation.GetTypeByMetadataName("BlacksmithCore.Infrastructure.Models.LifeCycle.ClapRoundClock");
        ...
        private static bool HasIsManualAttribute(INamedTypeSymbol symbol, Compilation compilation)
        {
            var isManualType = compilation.GetTypeByMetadataName(
                "BlacksmithCore.Infrastructure.Attributes.Analyzer.IsManual");
