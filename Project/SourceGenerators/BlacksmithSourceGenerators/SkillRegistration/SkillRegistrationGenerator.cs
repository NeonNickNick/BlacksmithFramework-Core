...
namespace BlacksmithSourceGenerators.SkillRegistration
{
    ...
    public class SkillRegistrationGenerator : IIncrementalGenerator
    {
        ...
        private static PackageInfo? GetPackageInfo(GeneratorSyntaxContext ctx)
        {
            ...
            var skillContextType = compilation.GetTypeByMetadataName("BlacksmithCore.Infrastructure.Models.Profession.ISkillCheckContext");
            var executeContextType = compilation.GetTypeByMetadataName("BlacksmithCore.Infrastructure.Models.Profession.ISkillExecuteContext");
            var dslSourceFileType = compilation.GetTypeByMetadataName("BlacksmithCore.Infrastructure.SkillSystem.SkillDSL.IDSLSourceFile");
